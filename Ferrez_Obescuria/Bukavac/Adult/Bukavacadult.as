...
void onTick(CBlob@ this)
{
	...
	{	
		...
		for (uint step = 0; step < blobs.length; ++step)
		{
			...
			{
				Vec2f vel(0,0);
				this.server_Hit(other,other.getPosition(),vel,6.0,Hitters_mod::saw, false);
				break;				
			}
		}	
	}
						...
						for (uint i = 0; i < hitInfos.length; i++)
						{
							...
							if (other !is null)
							{
								if ((other.hasTag("flesh") && other.getTeamNum() != this.getTeamNum()) || other.getName() == "bison" || other.getName() == "shark")
								{
									...
									this.server_Hit(other,other.getPosition(),vel,4.0,Hitters_mod::bite, false);
