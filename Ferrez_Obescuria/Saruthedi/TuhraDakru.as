const int FIRE_FREQUENCY = 120;
const int FIRE_FREQUENCY2 = 60;
const f32 BOLT_SPEED = 7.0f;
const f32 BOLT_SPEED2 = 14.0f;
const f32 max_range = 254.00f;
const f32 max_range2 = 254.00f;
...
void onTick(CBlob@ this)
{
	...
	if (getNet().isServer() && (this.getHealth()>0.5))
	{
		...
		if (diff > 0)
		{
			...
			CBlob@ bolt = server_CreateBlob("dakru", this.getTeamNum(), pos + Vec2f(0.0f, -0.5f * this.getRadius()));
			if (bolt !is null)
			{
				Vec2f norm = aim - pos;
				norm.Normalize();
