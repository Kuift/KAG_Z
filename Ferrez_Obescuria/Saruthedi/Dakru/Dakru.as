...
void onCollision(CBlob@ this, CBlob@ blob, bool solid, Vec2f normal, Vec2f point1)
{
	if (blob !is null && doesCollideWithBlob(this, blob) && !this.hasTag("collided") && !blob.hasTag("dead") )
	{
		...
		this.set_u8("custom_hitter", Hitters_modwater_stun);
		if(this.get_bool("justHit") == false)
		{
			this.server_Hit(blob, point1, normal, (0.5f), Hitters_modwater_stun); // You're my another favorite little meat grinder!
