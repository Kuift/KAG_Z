...
const int TELE_SPAWNING_FREQUENCY = 120;
const int TELE_SPAWNING_FREQUENCY_A = 90; 
const int TELE_SPAWNING_FREQUENCY_B = 60;  
...
void onTick(CBlob@ this)
{
	...
	if (playerBlob !is null && facingleft)
		{
		server_CreateBlob("vael", -1, playerBlob.getPosition() + Vec2f(-20, -50.0f));
		server_CreateBlob("vael", -1, playerBlob.getPosition() + Vec2f(0, -50.0f));
		server_CreateBlob("vael", -1, playerBlob.getPosition() + Vec2f(-50, -50.0f));
		break;
		}
