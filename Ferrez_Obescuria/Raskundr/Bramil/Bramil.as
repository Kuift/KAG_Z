...
void onCollision(CBlob@ this, CBlob@ blob, bool solid)
{
	...
	{
		if (isServer()) this.server_Hit(blob, this.getPosition(), blob.getVelocity() * -1, 2.0f, Hitters_mod::fall, true);
	}
}
...
f32 onHit(CBlob@ this, Vec2f worldPoint, Vec2f velocity, f32 damage, CBlob@ hitterBlob, u8 customData)
{
	...
	{
		if (isServer()) this.server_Hit(hitterBlob, this.getPosition(), Vec2f(0, 0), 1.0f, Hitters_mod::fall, false);
	}
