...
{		
	...
	if (customData == Hitters_mod::mine_special) damage*=0.1;
	if (customData == Hitters_mod::mine) damage*=0.1;
	if (customData == Hitters_mod::explosion) damage*=0.15;
	if (customData == Hitters_mod::keg) damage*=0.30;
