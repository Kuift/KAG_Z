...
void onTick(CBlob@ this)
{
	...
	if (this.getHealth()<=0.0 && (this.getTickSinceCreated() - this.get_u16("death ticks")) > 90)
	{
		this.server_SetHealth(3.0);
	...
	{	
		...
		for (uint step = 0; step < blobs.length; ++step)
		{
			...
			if (other.getName() == "lantern" || other.getName() == "stone_door" || other.getName() == "wooden_door" || other.getName() == "wooden_platform" || other.getName() == "GoldBrick" || other.getTeamNum()!=this.getTeamNum())
			{
				...
				this.server_Hit(other,other.getPosition(),vel,1.0,Hitters_mod::saw, false);
				else
						...
						for (uint i = 0; i < hitInfos.length; i++)
						{
							...
							if (other !is null)
							{
								if ((other.hasTag("flesh") && other.getTeamNum() != this.getTeamNum()) || other.getName() == "bison" || other.getName() == "shark")
								{
									...
									this.server_Hit(other,other.getPosition(),vel,2.0f,Hitters_mod::bite, false);
								...
								else if (!hit_block)
								{
									...
									{
										this.server_Hit(other,other.getPosition(),vel,2.0f,Hitters_mod::saw, false);
										this.set_u16("lastbite",0);
										hit_block=true;
									}
