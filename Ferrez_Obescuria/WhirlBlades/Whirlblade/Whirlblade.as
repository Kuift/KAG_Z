...
{
	return (isEnemy(this, b) || (b.getPlayer() !is null && this.getDamageOwnerPlayer() !is null&& b.getPlayer() is this.getDamageOwnerPlayer()|| b.getName() == this.getName() || b.getTeamNum() == this.getTeamNum() )); 
}
...
void onCollision( CBlob@ this, CBlob@ blob, bool solid, Vec2f normal)
{
	if (solid)
	{
		...
		{
			this.server_Hit(blob, blob.getPosition(), Vec2f(0,0), 1.0f, Hitters_modfall, true); 
		} 
	}
}
