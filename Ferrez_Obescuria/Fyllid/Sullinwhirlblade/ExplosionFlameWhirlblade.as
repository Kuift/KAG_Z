...
void Explode(CBlob@ this, f32 radius, f32 damage)
{
	...
	if (this.isInInventory())
	{
		...
		if (doomed !is null)
		{
			...
			if ((doomed.hasTag("player") || doomed.getName() == "crate") && !doomed.hasTag("invincible"))
			{
				...
				{
					this.server_Hit(doomed, pos, Vec2f(), 0.0f, Hitters_mod::explosion, true);
				}
				else if (this.getName() == "waterbomb") //stun player
				{
					this.server_Hit(doomed, pos, Vec2f(), 0.0f, Hitters_mod::water_stun_force, true);
				}
			}
		}
	}
	...
	bool should_teamkill = this.get_bool("explosive_teamkill");
