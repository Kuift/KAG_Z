...
void onCollision( CBlob@ this, CBlob@ blob, bool solid, Vec2f normal)
{
	if (solid)
	{
		...
		{
			this.server_Hit(blob, blob.getPosition(), Vec2f(0,0), 4.0f, Hitters_mod::fire, true); 
		} 
	}
}
...
void onDie(CBlob@ this)
{
	if (getNet().isServer() && this.hasTag("exploding"))
	{
		...
		for(u16 i = 0; i < blobs.length; i++)
		{
			...
			{
				this.server_Hit(target, POSITION, Vec2f_zero, 0.0f, Hitters_mod::notnormalfire, true);
			}
		}
	}
}
