...
void onCollision(CBlob@ this, CBlob@ blob, bool solid, Vec2f normal, Vec2f point1)
{
	...
	if (!solid && !blob.hasTag("flesh"))
		...
		this.set_u8("custom_hitter", Hitters_modnoise);
		this.server_Hit(blob, point1, normal, 3.0f*XORRandom(5)/2+1.5, Hitters_modnoise);
...
void Pierce(CBlob @this)
{
	...
	{
		HitMap(this, end, this.getOldVelocity(), 0.5f, Hitters_modnoise);
	}
}
...
void onHitBlob(CBlob@ this, Vec2f worldPoint, Vec2f velocity, f32 damage, CBlob@ hitBlob, u8 customData)
{
	...
	if (this !is hitBlob && customData == Hitters_modnoise)
	{
