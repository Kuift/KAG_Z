							...
							if (other !is null)
							{
								...
								else if (!hit_block)
								{
									...
									else
									{
										...
										this.server_Hit(other,other.getPosition(),vel,power,Hitters_mod::saw, false);
...
void onDie( CBlob@ this )
{
	if (!getNet().isServer()) return;
					...
					{
						server_CreateBlob("onestarbuilderuniform",this.getTeamNum(), this.getPosition());
					}
					else if (rs == 2)
					{
