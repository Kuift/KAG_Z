...
bool canGrowAt(CBlob@ this, Vec2f pos)
{
	...
	isTileSand
	isTileGroundStuff */
	return map.isTileStone(map.getTile(Vec2f(pos.x, pos.y + 8)).type) || map.isTileThickStone(map.getTile(Vec2f(pos.x, pos.y + 8)).type) || (map.isTileGround(map.getTile(Vec2f(pos.x, pos.y + 8)).type)) || map.isTileGroundStuff(map.getTile(Vec2f(pos.x, pos.y + 8)).type);
}
