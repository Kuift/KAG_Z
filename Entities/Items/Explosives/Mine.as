...
void onInit(CBlob@ this)
{
	...
	this.set_u8("custom_hitter", Hitters_mod::mine);
...
bool explodeOnCollideWithBlob(CBlob@ this, CBlob@ blob)
{
	...
	(blob.hasTag("flesh") || blob.hasTag("projectile") || blob.hasTag("vehicle") || (blob.hasTag("zombie") && blob.hasTag("portal_zombie")));
}
...
void onDie(CBlob@ this)
{
	if(getNet().isServer() && this.hasTag("exploding"))
	{
		...
		for(u16 i = 0; i < blobs.length; i++)
		{
			...
			{
				this.server_Hit(target, POSITION, Vec2f_zero, 8.0f, Hitters_mod::mine_special, true);
			}
		}
	}
}
...
{
	return customData == Hitters_mod::builder? this.getInitialHealth() / 2 : damage;
}
