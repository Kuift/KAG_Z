	...
	if (speed > 0.1f && map.getHitInfosFromArc(tail_position, -angle, 10, (tip_position - tail_position).getLength(), this, true, @infos))
	{
		...
		for (uint i = 0; i < infos.length; i ++)
		{
			...
			if (blob !is null)
			{
				...
				this.server_Hit(blob, hit_position, velocity, damage, Hitters_mod::ballista, true);
				BallistaHitBlob(this, hit_position, velocity, damage, blob, Hitters_mod::ballista);
