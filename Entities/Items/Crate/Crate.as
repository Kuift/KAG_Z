...
void onInit(CBlob@ this)
{
	...
	if (this.exists("frame"))
	{
		...
		// GIANT HACK!!!
		if (packed == "catapult" || packed == "gunship" || packed == "bomber" || packed == "ballista" || packed == "mounted_bow" || packed == "longboat")	 // HACK:
		{
