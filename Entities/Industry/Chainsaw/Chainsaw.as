						...
						for (uint i = 0; i < hitInfos.length; i++)
						{
							...
							if (b !is null) // blob
							{
								...
								if (getNet().isServer())
								{
									...
									this.server_Hit(hi.blob, hi.hitpos, attackVel, attack_dam, Hitters_moddrill);
								...
								hitwood = true;
								if (!hi.blob.hasTag("stone")) holder.server_Hit( hi.blob, hi.hitpos, attackVel, attack_dam, Hitters_modsaw );
