...
void Blend( CBlob@ this, CBlob@ tobeblended )
{
	...
	if (tobeblended.getPlayer() !is null && tobeblended.getTeamNum() == this.getTeamNum() || tobeblended.getName() == "horror"  )
	{
		CBitStream params;
...
void onCollision( CBlob@ this, CBlob@ blob, bool solid )
{
	...
	if(canSaw(this,blob))
	{
		...
		Vec2f bpos = blob.getPosition();
		this.Tag("sawed");
		this.server_Hit( blob, bpos, bpos - pos, 0.0f, Hitters_mod::saw );
	}
}
