...
const f32 heal_amount = 0.25f; //0.25f
const u8 heal_rate = 15; //30
...
void onInit(CBlob@ this)
{
	...
	{
		ShopItem@ s = addShopItem(this, "Gramophone", "$gramophone$", "gramophone", "Plays discs.", true);
		AddRequirement(s.requirements, "coin", "", "Coins", 20);
		AddRequirement( s.requirements, "no more", "gramophone", "Gramophone", 1 );
	}
	{
		ShopItem@ s = addShopItem(this, "MusicDisc", "$musicdisc$", "musicdisc", "music", true);
