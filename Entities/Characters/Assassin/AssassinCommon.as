...
namespace KnightVars
{
	...
	const ::s32 slash_charge_limit = slash_charge_level2 + slash_charge + 30;
...
const string[] bombNames = { "Cluster Bomb",
                             "Water Bomb"
                           };

const string[] bombIcons = { "$ClusterBomb$",
                             "$WaterBomb$"
                           };

const string[] bombTypeNames = { "mat_clusterbomb",
                                 "mat_waterbombs"
                               };
