...
void DoAttack(CBlob@ this, f32 damage, f32 aimangle, f32 arcdegrees, u8 type, int deltaInt, DarkKnightInfo@ info)
{
	if (!getNet().isServer())
	{
		return;
...
bool isSliding(DarkKnightInfo@ knight)
{
